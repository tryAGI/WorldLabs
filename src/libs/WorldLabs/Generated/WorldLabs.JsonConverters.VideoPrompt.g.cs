...
{
    /// <inheritdoc />
    public class VideoPromptJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::WorldLabs.VideoPrompt>
    {
        /// <inheritdoc />
        public override global::WorldLabs.VideoPrompt Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::WorldLabs.VideoPromptInputVideoPromptDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::WorldLabs.VideoPromptInputVideoPromptDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::WorldLabs.VideoPromptInputVideoPromptDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::WorldLabs.MediaAssetReference? mediaAsset = default;
            if (discriminator?.Source == global::WorldLabs.VideoPromptInputVideoPromptDiscriminatorSource.MediaAsset)
            {
            ...
            if (discriminator?.Source == global::WorldLabs.VideoPromptInputVideoPromptDiscriminatorSource.Uri)
            {
            ...
            if (discriminator?.Source == global::WorldLabs.VideoPromptInputVideoPromptDiscriminatorSource.DataBase64)
            {
            ...
            var __value = new global::WorldLabs.VideoPrompt(
        ...
        public override void Write(
            ...
            global::WorldLabs.VideoPrompt value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
