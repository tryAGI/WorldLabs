...
namespace WorldLabs
{
    ...
    public sealed partial class GetOperationResponseUnionWorldPanoDepthToRgbResultExportWorldResult
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetOperationResponseUnionWorldPanoDepthToRgbResultExportWorldResult" /> class.
        /// </summary>
        /// <param name="done">
        /// True if the operation is completed
        /// </param>
...
#endif
        public GetOperationResponseUnionWorldPanoDepthToRgbResultExportWorldResult(
            bool done,
            string operationId,
