...
namespace WorldLabs
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::WorldLabs.AutoSDKRetryOptions Retry { get; set; } = new global::WorldLabs.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::WorldLabs.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::WorldLabs.IAutoSDKHook>();
        ...
        public global::WorldLabs.AutoSDKClientOptions AddHook(
            global::WorldLabs.IAutoSDKHook hook)
        {
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::WorldLabs.AutoSDKAuthorizationValue>?> ResolveAsync(
...
#pragma warning restore CS0618
    ...
    public sealed class AutoSDKAuthorizationProviderHook : global::WorldLabs.AutoSDKHook
    {
            ...
            global::WorldLabs.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::WorldLabs.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::WorldLabs.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::WorldLabs.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::WorldLabs.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::WorldLabs.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::WorldLabs.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::WorldLabs.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::WorldLabs.AutoSDKClientOptions clientOptions,
            global::WorldLabs.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::WorldLabs.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::WorldLabs.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::WorldLabs.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::WorldLabs.AutoSDKClientOptions clientOptions,
            global::System.Func<global::WorldLabs.IAutoSDKHook, global::WorldLabs.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::WorldLabs.AutoSDKHookContext context)
        {
