...
{
    /// <inheritdoc />
    public class Content2JsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::WorldLabs.Content2>
    {
        /// <inheritdoc />
        public override global::WorldLabs.Content2 Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::WorldLabs.SphericallyLocatedContentInputContentDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::WorldLabs.SphericallyLocatedContentInputContentDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::WorldLabs.SphericallyLocatedContentInputContentDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::WorldLabs.MediaAssetReference? mediaAsset = default;
            if (discriminator?.Source == global::WorldLabs.SphericallyLocatedContentInputContentDiscriminatorSource.MediaAsset)
            {
            ...
            if (discriminator?.Source == global::WorldLabs.SphericallyLocatedContentInputContentDiscriminatorSource.Uri)
            {
            ...
            if (discriminator?.Source == global::WorldLabs.SphericallyLocatedContentInputContentDiscriminatorSource.DataBase64)
            {
            ...
            var __value = new global::WorldLabs.Content2(
        ...
        public override void Write(
            ...
            global::WorldLabs.Content2 value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
