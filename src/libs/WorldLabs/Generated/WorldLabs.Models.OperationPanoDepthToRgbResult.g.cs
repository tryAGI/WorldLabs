...
namespace WorldLabs
{
    ...
    public sealed partial class OperationPanoDepthToRgbResult
    {
        ...
        public global::WorldLabs.PanoDepthToRgbResult? Response { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OperationPanoDepthToRgbResult" /> class.
        /// </summary>
        /// <param name="done">
        /// True if the operation is completed
        /// </param>
...
#endif
        public OperationPanoDepthToRgbResult(
            bool done,
            string operationId,
            ...
            object? metadata,
            global::WorldLabs.PanoDepthToRgbResult? response,
