...
namespace WorldLabs
{
    public partial class WorldLabsClient
    {
        ...
        {
            var __response = await GetWorldMarbleV1WorldsWorldIdGetAsResponseAsync(
                worldId: worldId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::WorldLabs.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::WorldLabs.AutoSDKHttpResponse<global::WorldLabs.World>> GetWorldMarbleV1WorldsWorldIdGetAsResponseAsync(
            string worldId,
            global::WorldLabs.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
                    ...
                    await global::WorldLabs.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::WorldLabs.World.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::WorldLabs.AutoSDKHttpResponse<global::WorldLabs.World>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::WorldLabs.World.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
