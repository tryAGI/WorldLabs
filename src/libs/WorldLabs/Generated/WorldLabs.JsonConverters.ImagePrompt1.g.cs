...
{
    /// <inheritdoc />
    public class ImagePrompt1JsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::WorldLabs.ImagePrompt1>
    {
        /// <inheritdoc />
        public override global::WorldLabs.ImagePrompt1 Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::WorldLabs.ImagePromptImagePrompt1Discriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::WorldLabs.ImagePromptImagePrompt1Discriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::WorldLabs.ImagePromptImagePrompt1Discriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::WorldLabs.MediaAssetReference? mediaAsset = default;
            if (discriminator?.Source == global::WorldLabs.ImagePromptImagePrompt1DiscriminatorSource.MediaAsset)
            {
            ...
            if (discriminator?.Source == global::WorldLabs.ImagePromptImagePrompt1DiscriminatorSource.Uri)
            {
            ...
            if (discriminator?.Source == global::WorldLabs.ImagePromptImagePrompt1DiscriminatorSource.DataBase64)
            {
            ...
            var __value = new global::WorldLabs.ImagePrompt1(
        ...
        public override void Write(
            ...
            global::WorldLabs.ImagePrompt1 value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
