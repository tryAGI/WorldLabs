...
internal static class CliRuntime
{
    ...
    public static async Task<global::WorldLabs.WorldLabsClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
    ...
    private static async Task WriteApiExceptionAsync(global::WorldLabs.ApiException exception)
    {
        var builder = new StringBuilder();
