...
{
    private const string UserSecretsId = "WorldLabs.CLI";
    private const string UserSecretApiKeyName = "WORLDLABS_API_KEY";
    private static readonly string[] ApiKeyEnvironmentVariables = [@"WORLDLABS_API_KEY"];
    private const string CredentialFileDirectoryName = ".world-labs";

    public static async global::System.Threading.Tasks.Task<global::WorldLabs.WorldLabsClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
        ...
        return new global::WorldLabs.WorldLabsClient(
            httpClient: null,
            baseUri: baseUri,
    ...
    private static Uri? ResolveBaseUri(ParseResult parseResult)
    {
        ...
        {
            baseUrl = Environment.GetEnvironmentVariable("WORLDLABS_BASE_URL");
        }
    ...
    private static async global::System.Threading.Tasks.Task WriteApiExceptionAsync(global::WorldLabs.ApiException exception)
    {
        var builder = new StringBuilder();
